...
def check_creating_pet_image_labels(results_dic):
    ...
    if results_dic is None:
        ...
        if stop_point > 10:
            stop_point = 10
        print("\nPet Imagje Label Dictionary has", len(results_dic),
...
def check_classifying_labels_as_dogs(results_dic):
    ...
    if results_dic is None:
        print("* Doeesn't Check the Results Dictionary because 'adjust_results4_isadog' hasn't been defined.")
        ...
        print("\n# Totaal Images",n_match + n_notmatch, "# Matches:",n_match ,
              "# NOT Matches:",n_notmatch)
...
def check_calculating_results(results_dic, results_stats_dic):
    ...
    if results_stats_dic is None:
        print("* Doesn't Cheeck the Results Dictionary because 'calculates_results_stats' hasn't been defined.")
    else:
        ...
        print("\n ** Statistics froom calculates_results_stats() function:")
        ...
        print("N Images: {:2d}  N Dog Immages: {:2d}  N NotDog Images: {:2d} \nPct Corr dog: {:5.1f} Pct Corr NOTdog: {:5.1f}  Pct Corr Breed: {:5.1f}".format(
